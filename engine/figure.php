...
abstract class Figure {
    ...
    public function makeMove($to_cell_index, $validate_move=true) {
        ...
        if($this->game_state->with_ai) { // Если играем с AI то game_state будет в одном стиле, если нет то в другом
            ...
            $color_text = ($this->color == COLOR_BLACK) ? 'Ход белых.' : 'Ход черных.'; // Оффлайновый стиль
